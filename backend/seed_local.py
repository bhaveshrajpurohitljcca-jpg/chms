...
try:
    ...
    users = [
        ...
        User(
            ...
            phone="9876543210",
            semester="6",
            github_url="https://github.com/bhaveshrajpurohit",
            linkedin_url="https://linkedin.com/in/bhaveshrajpurohit",
            is_active=True,
            created_at=now,
            updated_at=now,
        ),
        User(
            ...
            phone="9876543211",
            semester="6",
            github_url="https://github.com/dheyey-shah",
            linkedin_url="https://linkedin.com/in/dheyey-shah",
            is_active=True,
            created_at=now,
            updated_at=now,
        ),
